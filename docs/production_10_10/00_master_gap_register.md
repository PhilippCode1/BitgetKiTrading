...
| Legacy-Kunden-/Billing-UI (Dashboard) | (Product)      | L3 CI Build+Jest+E2E fuer Secret-Sicherheit und deaktivierte/out-of-scope Legacy-Pfade; L4 Owner-UAT der Main Console | L2-L3: Customer-Portal-Skeleton + BFF-Stub (`not_configured` moeglich), aber nicht mehr Produktziel | Muss inventarisiert und zugunsten der privaten deutschen Main Console konsolidiert oder deaktiviert werden; keine Commerce-/Billing-/Sales-Freigabe als Ziel |
