...
| `BITGET_BTC_AI_REPO_ROOT`, `REPO_ROOT`                                                                                                                                | Optional: absolute Monorepo-Wurzel, wenn der Next.js-Prozess nicht unter der Repo-Wurzel startet. Die Main-Console-Evidence-Ansicht (`apps/dashboard/src/lib/evidence-console.ts`) laedt `docs/production_10_10/evidence_matrix.yaml` relativ dazu; sonst Heuristik `cwd/../..` aus `apps/dashboard`. |
