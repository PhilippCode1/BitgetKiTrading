...
RoutePayloadT = TypeVar("RoutePayloadT", bound=RoutePayload)
...
def _payload(value: Any) -> RoutePayload:
    return cast(RoutePayload, value)


def build_ops_router(runtime: Any) -> APIRouter:
    router = APIRouter(prefix="/live-broker", tags=["live-broker"])
    require_internal = build_internal_service_dependency(runtime.settings)
    internal_auth_dependency = Depends(require_internal)

    @router.get("/runtime")
    def runtime_view(
        _auth: InternalServiceAuthContext = internal_auth_dependency,
    ) -> RoutePayload:
        return _payload(runtime.runtime_payload())
    ...
    def evaluate_execution(
        ...
        return _payload(runtime.execution_service.evaluate_intent(body))
    ...
    def execution_telegram_summary(
        ...
        return _payload(
            runtime.execution_service.telegram_operator_release_summary(
                str(execution_id)
            )
        )
    ...
    def operator_release_execution(
        ...
        return _wrap_bitget_error(
            lambda: _payload(
                runtime.execution_service.record_operator_release(
                    str(execution_id),
                    source=eff.source,
                    details=eff.audit,
                )
    ...
    def capability_matrix(
        ...
        """
        return _payload(runtime.control_plane.matrix_payload())
    ...
    def control_plane_read_orders_history(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.control_plane.read_orders_history(body))
        )
    ...
    def control_plane_read_fill_history(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.control_plane.read_fill_history(body))
        )
    ...
    def control_plane_operator_set_leverage(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.control_plane.set_leverage_operator(body))
        )
    ...
    def create_order(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.create_order(body))
        )
    ...
    def create_reduce_only_order(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.create_reduce_only_order(body))
        )
    ...
    def cancel_order(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.cancel_order(body))
        )
    ...
    def replace_order(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.replace_order(body))
        )
    ...
    def query_order(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.query_order(body))
        )
    ...
    def arm_kill_switch(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.arm_kill_switch(body))
        )
    ...
    def release_kill_switch(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.release_kill_switch(body))
        )
    ...
    def emergency_flatten(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.emergency_flatten(body))
        )
    ...
    def safety_cancel_all_orders(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.cancel_all_orders_operator(body))
        )
    ...
    def safety_latch_release(
        ...
        return _payload(runtime.order_service.release_safety_latch(body))
    ...
    def run_order_timeouts(
        ...
        return _wrap_bitget_error(
            lambda: _payload(runtime.order_service.run_order_timeouts())
        )

    return router


def _wrap_bitget_error(callback: Callable[[], RoutePayloadT]) -> RoutePayloadT:
    try:
        return callback()
