...
def test_check_redis_url_readiness_empty() -> None:
    from shared_py.observability.health import check_redis_url_readiness
...
def test_check_redis_url_readiness_retries_then_ok() -> None:
    from shared_py.observability.health import check_redis_url_readiness
