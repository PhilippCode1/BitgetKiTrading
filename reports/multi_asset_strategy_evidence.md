...
## strat_major_momentum / BTCUSDT
- Asset-Klasse: `major_high_liquidity`
- Market-Family: `futures`
- Bewertung: `PASS`
- Entscheidung (de): Strategie strat_major_momentum für BTCUSDT/major_high_liquidity: Eignung ausreichend (PASS).
- Blockgründe (de): keine

## strat_new_listing_guard / NEWCOINUSDT
- Asset-Klasse: `new_listing`
- Market-Family: `futures`
- Bewertung: `FAIL`
