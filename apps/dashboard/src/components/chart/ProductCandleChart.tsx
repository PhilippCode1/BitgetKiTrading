 ...
 */
export const ProductCandleChart = forwardRef<ProductCandleChartHandle, Props>(
  function ProductCandleChart(
    ...
    const lastCandlesPropsRef = useRef<readonly ProductCandleBar[] | null>(
      null,
    );
